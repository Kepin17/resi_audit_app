    ...
    <div className="relative h-screen bg-white overflow-hidden">
      {!imgSrc ? (
        <>
          ...
          <div className={`absolute ${isPortrait ? "bottom-40 right-6" : "right-10 top-1/2 -translate-y-1/2"} flex ${isPortrait ? "flex-row" : "flex-col"} gap-6`}>
          ...
          <div className={`absolute ${isPortrait ? "bottom-40 left-1/2 -translate-x-1/2" : "right-10 top-1/2 -translate-y-1/2"} flex ${isPortrait ? "flex-row" : "flex-col"} gap-6`}>
